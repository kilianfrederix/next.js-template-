...
- 🔒 Kinde Auth - Easy authentication library for Next.js (Azure/Google/Linkedin provider)
...
## 🚀 Deployment
Easily deploy your app to Azure by creating a web app service and connecting it to your GitHub repository.
...
2. Using `create-next-app`
   ...
   ```bash
   npx create-next-app -e https://github.com/Acco-Group/template-nextjs-fastapi-frontend my-project-name
   ```
    
3. Using `git clone`

   ```bash
   git clone https://github.com/Acco-Group/template-nextjs-fastapi-frontend my-project-name
   ```
...
Initial template made by <a href="https://michalskolak.netlify.app/">Michał Skolak</a> 
